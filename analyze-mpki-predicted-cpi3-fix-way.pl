#!/usr/bin/perl -w
#
# analyze-mpki-predicted-cpi3-fix-way - analyze the divergencs in cache 
...
print_avg("Increase in relative speedup", \@weighted_speedup, $total2);
...
print_avg("Increase in relative ipc", \@relative_ipc, $total2);
